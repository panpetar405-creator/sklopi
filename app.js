...
const AIRPORT_DB = {
  ...
  'čijapas': {hasAirport:true, limited:true},
  ...
  'kanjon sumidero': {nearest:'Čijapas', note:'Kanjon Sumidero nema aerodrom u blizini — najbliži je Tukstla Gutijeres (oko 30 min vožnje).', c:'Kanjon Sumidero', k:'nearby', t:'30 min'},
...
const POPULAR_DESTINATIONS = [
  ...
  {name:'Zakatekas', extra:'Meksiko'}, {name:'Kampeče', extra:'Meksiko'}, {name:'Čijapas', extra:'Meksiko'},
  ...
  {name:'Havana', extra:'Kuba'}, {name:'Varadero', extra:'Kuba'},

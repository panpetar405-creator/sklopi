...
const I18N = {
  sr: {
    ...
    h2_no_idea:'Ne znaš gde bi išao?', sub_no_idea:'Unesi budžet i pronaći ćemo ti nekoliko gotovih ideja za ceo izlet.',
    btn_no_idea_cta:'🎲 Iznenadi me',
    eyebrow_more_control:'Više kontrole', h2_build_own:'Želiš da biraš svaki detalj?',
    sub_build_own:'Sastavi svoj izlet - od leta i smeštaja do auta i aktivnosti.',
    ...
    btn_optimize:'Optimizuj moj aranžman', btn_save_trip:'Sačuvaj izlet', btn_price_alert:'Javi mi kad padne cena',
    builder_placeholder_text:'Ovde ćeš videti procenjenu cenu čim počneš da biraš — promeni bilo koju opciju levo.',
    eyebrow_for_later:'Za kasnije', h2_saved_trips:'Sačuvaj izlet za kasnije',
    sub_saved_trips:'Vrati mu se kada budeš spreman da rezervišeš.',
    h2_features:'Sve za put, na jednom mestu', sub_features:'Uporedi i uklopi let, smeštaj, auto, aktivnosti, putarine, osiguranje i eSIM.',
    f_car_name:'Auto',
    ...
    eyebrow_ideas:'Ideje za sledeći izlet', h2_popular_dest:'Ne znaš gde sledeće? Počni ovde.',
    sub_popular_dest:'Pogledaj popularne destinacije i pronađi ideju za svoj sledeći izlet.',
    ...
    faq_a3:'Napraviš nalog emailom i lozinkom u sekciji „Sačuvani izleti". Tvoji podaci se čuvaju vezano za tvoj nalog, ne za ovaj uređaj, tako da im možeš pristupiti i sa drugog telefona ili računara — samo se prijavi istim emailom i lozinkom.',
  ...
  en: {
    ...
    h2_no_idea:'Not sure where to go?', sub_no_idea:'Enter a budget and we’ll find you a few ready-made ideas for the whole trip.',
    ...
    sub_saved_trips:'Come back to it when you’re ready to book.',
...
function ctaCopy(dest){
  ...
  return 'Istorija, dobra hrana i nezaboravni doživljaji — a sad je lakše nego ikad da sve to isplaniraš.';
}
  ...
  head.innerHTML = `
    <div class="status-banner">
      <div class="status-left">
        ...
        <div><h2>Tvoj izlet za ${escapeHtml(dest)}</h2><p>Izaberi paket koji ti najviše odgovara ili prilagodi detalje po svom ukusu.</p></div>
      </div>
